...
(defcustom org-velocity-follow-immidiately t
  "Prompt to follow note instead of going straight there?"
  :group 'org-velocity
  :type 'boolean
  :safe 'booleanp)
  ...
  (let ((org-velocity-search search))
    (unless (or
      ...
      (case
        ...
        (:force (org-velocity-create search))
        (:follow (if (or org-velocity-follow-immidiately (y-or-n-p "One match, follow? "))
                     (progn
