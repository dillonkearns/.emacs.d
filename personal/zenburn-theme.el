...
;;;;; org-mode
   ...
   `(org-level-1 ((t (:foreground ,zenburn-orange :height 1.5))))
   `(org-level-2 ((t (:foreground ,zenburn-green+4 :height 1.2))))
   `(org-level-3 ((t (:foreground ,zenburn-blue-1 :height 1.0))))
   `(org-level-4 ((t (:foreground ,zenburn-yellow-2 :height 1.0))))
